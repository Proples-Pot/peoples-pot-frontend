        ...
        <div className={classes.root}>
          <div className={ classes.carouselContainer }>
            ...
            <div style={{display:"flex", flexDirection:"column", alignItems:"center", marginTop:"85px"}}>
              <img width={"100PX"} alt="logo" src="/images/favicon.png">
              </img>
            </div>
            
           
        <Typography style={{textAlign:"center", marginTop:"50px", marginBottom:"50px"}} variant="h3"> Peer-to-Peer Group Saving Funds, Empowering Communities to Save and Invest Together
